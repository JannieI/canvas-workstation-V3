...
export class DataManagedGraphQLEditorComponent implements OnInit {
	...
	ngOnInit() {
        ...
        if (this.selectedDatasource == null) {
            ...
            this.selectedDatasource.createMethod = 'managedGraphQLEditor';
            this.selectedDatasource.cacheResultsOnServer = true;
            ...
            this.selectedDatasource.dataGraphQLStatement = `
                    query {
                        all_users {
                            id
                            username
