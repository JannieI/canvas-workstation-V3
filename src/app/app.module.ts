...
import { DashboardScheduleLogComponent }        from './dashboard.scheduleLog.component';
...
import { NavigatorEditorComponent }   from './navigator.editor.component';
...
import { WidgetNavigatorComponent }   from './widget.navigator.component';
...
import { DataCreateDSSQLEditorComponent }      from './data.createDS.sqlEditor.component';
...
@NgModule({
    declarations: [
        ...
        DataCreateDSSQLEditorComponent,
