...
@Component({
    selector: 'data-shareNEW',
    templateUrl: './data.share.componentNEW.html',
    styleUrls: ['./data.share.componentNEW.css']
})
export class DatasourceShareComponentNEW implements OnInit {
