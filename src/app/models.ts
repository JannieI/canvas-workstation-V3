...
// a new version with a new ID is created.  If this product is referenced in a license,
// that license is upgraded to a new version, the current record is stored in the
// productLicense collection and all affected users (as defined in the productLicense)
// is updated as well.
