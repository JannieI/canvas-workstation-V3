...
// a new version with a new ID is created.  The current version is stored in the 
...
// the current record is stored in the canvasLicenseHistory collection and all affected  
// users are updated as well.
