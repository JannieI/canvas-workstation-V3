...
export class DataDirectQueryBuilderComponent implements OnInit {
    ...
    clickSave(action: string) {
        ...
        let newDatasource: Datasource =  {
            ...
            cacheServerStorageID: this.selectedDatasource.cacheServerStorageID,
            unRefreshable: this.selectedDatasource.unRefreshable,
            singleCache: this.selectedDatasource.singleCache,
            cacheResultsLocal: this.selectedDatasource.cacheResultsLocal,
            cacheLocalStorageID: this.selectedDatasource.cacheLocalStorageID,
            isLocalDirty: this.selectedDatasource.isLocalDirty,
